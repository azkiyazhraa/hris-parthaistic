...
<aside id="default-sidebar" data-drawer-backdrop="false"
    ...
    aria-label="Sidebar">
    <div class="h-full flex flex-col px-3 py-5 overflow-y-auto bg-blue-800 text-white">

        <!-- LOGO -->
        <a href="/dashboard" class="flex items-center justify-center py-3 mb-2">
            <img src="{{ asset('assets/image/logo-partharis-white.png') }}" alt="Partharis Logo" class="h-10 w-auto">
        </a>

        <div class="border-t border-blue-700 mb-3"></div>

        <!-- NAV -->
        <ul class="flex-1 space-y-0.5 text-sm font-medium">

            <li>
                <a href="{{ route('admin.dashboard') }}"
                    class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors
                    {{ request()->routeIs('admin.dashboard') || request()->routeIs('karyawan.dashboard') ? 'bg-gray-100 text-blue-800 font-semibold' : 'hover:bg-blue-700' }}">
            ...
            @if (Auth::user()->role == 'karyawan')
                <li>
                    <a href="{{ route('profile.edit') }}"
                        class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors
                        {{ request()->routeIs('profile.edit') ? 'bg-gray-100 text-blue-800 font-semibold' : 'hover:bg-blue-700' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                ...
                <li>
                    <a href="{{ route('absensi.index') }}"
                        class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors
                        {{ request()->routeIs('absensi.*') ? 'bg-gray-100 text-blue-800 font-semibold' : 'hover:bg-blue-700' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                ...
                <li>
                    <a href="{{ route('penggajian.index') }}"
                        class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors
                        {{ request()->routeIs('penggajian.*') ? 'bg-gray-100 text-blue-800 font-semibold' : 'hover:bg-blue-700' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                ...
                <li>
                    <a href="{{ route('cuti.index') }}"
                        class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors
                        {{ request()->routeIs('cuti.*') ? 'bg-gray-100 text-blue-800 font-semibold' : 'hover:bg-blue-700' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                ...
                <li>
                    <a href="{{ route('changeday.index') }}"
                        class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors
                        {{ request()->routeIs('changeday.*') ? 'bg-gray-100 text-blue-800 font-semibold' : 'hover:bg-blue-700' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                ...
                <li>
                    <a href="{{ route('performa.index') }}"
                        class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors
                        {{ request()->routeIs('performa.*') ? 'bg-gray-100 text-blue-800 font-semibold' : 'hover:bg-blue-700' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                ...
                @if (auth()->user()->isAdmin() || auth()->user()->isHR())
                    ...
                    @if (Auth::user()->role == 'hr' || Auth::user()->role == 'admin')
                        <li>
                            <a href="{{ route('admin.karyawan') }}"
                                class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors
                                {{ request()->routeIs('admin.karyawan') ? 'bg-gray-100 text-blue-800 font-semibold' : 'hover:bg-blue-700' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                    ...
                    <li>
                        <a href="{{ route('admin.absensi.index') }}"
                            class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors
                            {{ request()->routeIs('admin.absensi.*') ? 'bg-gray-100 text-blue-800 font-semibold' : 'hover:bg-blue-700' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 13.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25ZM6.75 12h.008v.008H6.75V12Zm0 3h.008v.008H6.75V15Zm0 3h.008v.008H6.75V18Z" />
                            </svg>
                            <span>Attendance</span>
                    ...
                    <li>
                        <a href="{{ route('admin.penggajian.index') }}"
                            class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors
                            {{ request()->routeIs('admin.penggajian.*') ? 'bg-gray-100 text-blue-800 font-semibold' : 'hover:bg-blue-700' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Z" />
                            </svg>
                            <span>Payroll</span>
                    ...
                    <li>
                        <a href="{{ route('admin.leave.index') }}"
                            class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors
                            {{ request()->routeIs('admin.leave.*') ? 'bg-gray-100 text-blue-800 font-semibold' : 'hover:bg-blue-700' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15m3 0 3-3m0 0-3-3m3 3H9" />
                            </svg>
                            <span>Leave</span>
                    ...
                    <li>
                        <a href="{{ route('admin.changeday.index') }}"
                            class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors
                            {{ request()->routeIs('admin.changeday.*') ? 'bg-gray-100 text-blue-800 font-semibold' : 'hover:bg-blue-700' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M3 7.5 7.5 3m0 0L12 7.5M7.5 3v13.5m13.5 0L16.5 21m0 0L12 16.5m4.5 4.5V7.5" />
                            </svg>
                            <span>Change Day</span>
                    ...
                    <li>
                        <a href="{{ route('admin.performa.index') }}"
                            class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors
                            {{ request()->routeIs('admin.performa.*') ? 'bg-gray-100 text-blue-800 font-semibold' : 'hover:bg-blue-700' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 shrink-0">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18 9 11.25l4.306 4.306a11.95 11.95 0 0 1 5.814-5.518l2.74-1.22m0 0-5.94-2.281m5.94 2.28-2.28 5.941" />
                            </svg>
                            <span>Performance</span>

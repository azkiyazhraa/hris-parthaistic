                ...
                <div class="grid grid-cols-1 gap-4">
                    <div>
                        ...
                        <input type="email" name="tracker_email" disabled
                            ...
                            class="w-full px-3 py-2 text-gray-500 bg-gray-100 border rounded-lg cursor-not-allowed">
                        <p class="mt-1 text-xs text-gray-400">
                            Locked — Tracker/Trello email can only be filled in when an employee is first created and

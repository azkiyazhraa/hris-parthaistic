                                        ...
                                        <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data"
                                            ...
                                            <div>
                                                ...
                                                <div class="grid md:grid-cols-2 gap-x-10 gap-y-4 text-sm">
                                                    ...
                                                    <div class="space-y-4">
                                                        <div>
                                                            <label class="text-gray-400 block mb-1">Full Name<span
                                            ...
                                            <div>
                                                ...
                                                <div class="grid md:grid-cols-2 gap-4 text-sm">
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="text" value="{{ ucfirst($karyawan->role) }}" readonly
                                                            class="w-full border rounded-lg px-3 py-2 bg-gray-100">
                                                    </div>
    ...
    $fotoUrl =
        ...
        urlencode($karyawan->nama_lengkap);
                                        ...
                                        <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data"
                                            ...
                                            @csrf
                                            @method('PATCH')
                                            <input type="hidden" name="nama_lengkap" value="{{ $karyawan->nama_lengkap }}">
